...
import com.company.model.SizeInteger;
...
public class MainWindowController extends BaseController implements Initializable {
    ...
    private MenuItem markDeleted = new MenuItem("Delete message");
    ...
    private void setUpContextMenus() {
        ...
        markDeleted.setOnAction(event -> {
            emailManager.setDeleted();
    ...
    private void setUpEmailsTableView() {
        ...
        emailsTableView.setContextMenu(new ContextMenu(markUnread, markDeleted, showMessageDetailsMenuItem));
    }
